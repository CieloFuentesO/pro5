...
use App\Imports\DocumentsImportTectelFormat;
...
class DocumentController extends Controller
{
    ...
    public function index()
    {
        ...
        $import_documents_tectel = config('tenant.import_documents_tectel_format');
...
//        return $observations;
    ...
    public function importTectelFormat(Request $request)
    {
        if ($request->hasFile('file')) {
            try {
                $import = new DocumentsImportTectelFormat();
                $import->import($request->file('file'), null, Excel::XLSX);
                $data = $import->getData();
                return [
                    'success' => true,
