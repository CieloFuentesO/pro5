...
<table class="full-width">
    <tr>
        <td class="desc pt-5" style="text-align:justify;" colspan="2"><b>Importante:</b><br>
            ...
            2) A excepción de una coordinación previa con el cliente, luego de los 30 días calendario de la fecha pactada de recojo, el Centro Óptico Guillén Tamayo S.R.L. se reserva el derecho de disponer los trabajos no recogidos para los fines que se vean por convenientes.<br><br>

            3) Los lentes con filtro de Luz azul suelen tener una tonalidad residual (Amarillenta).<br><br>

            4) El Centro Óptico no se responsabilizará por modificaciones posteriores a la firma de conformidad de comprobante (Lentes o Monturas).<br><br>
            
            5) No se recomienda el uso de alcohol ya que puede resecar la montura y dañar los tratamientos de los lentes.<br><br>

            6) El Centro Óptico no se responsabilizará por reclamos posteriores.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="text-center desc pt-5" colspan="2">Representación impresa de la {{ $document->document_type->description }}, puede consultar este comprobante ingresando a {!! url('/buscar') !!}</td>
    </tr>
    <tr>
