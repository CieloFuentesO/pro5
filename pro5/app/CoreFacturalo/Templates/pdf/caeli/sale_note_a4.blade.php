...
<table class="full-width mt-10 mb-10">
    ...
    @foreach($document->items as $row)
        <tr>
            ...
            <td class="text-left align-top">{{ $row->item->brand != null ? $row->item->brand : '' }}</td>
            <td class="text-center align-top">
            ...
            <td class="text-center align-top">
                @if(isset($row->item) && isset($row->item->lots_group[0]->date_of_due))
                    <span style="font-size: 9px"> {{ $row->item->lots_group[0]->date_of_due }}</span><br>
                @endif
