@php
    ...
    $marcas = app_path('CoreFacturalo'.DIRECTORY_SEPARATOR.'Templates'.DIRECTORY_SEPARATOR.'pdf'.DIRECTORY_SEPARATOR.'tecyme'.DIRECTORY_SEPARATOR.'marcas.png');
@endphp
<html>
<head>
    {{--<title>{{ $tittle }}</title>--}}
        ...
        @if($company->logo)
            <td width="30%" style="text-align:center;">
                <div class="company_logo_box">
                    <img src="data:{{mime_content_type(public_path("storage/uploads/logos/{$company->logo}"))}};base64, {{base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->logo}")))}}" alt="{{$company->name}}" class="company_logo" style="max-width: 210px;">
                </div>
                <hr>
                <div class="company_logo_box">
                    <img src="data:{{mime_content_type($marcas)}};base64, {{base64_encode(file_get_contents($marcas))}}" alt="{{$company->name}}" class="company_logo" style="max-width: 280px;">
                </div>
            </td>
        @else
            <td width="30%">
