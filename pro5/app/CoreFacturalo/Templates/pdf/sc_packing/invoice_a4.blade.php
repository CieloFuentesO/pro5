...
<table class="full-width">
    <tr>
        ...
        <td width="30%" class="border-box py-4 px-2 text-center">
            <h5 class="text-center">R.U.C. {{ $company->number }}</h5>
...
<table class="full-width mt-3">
    ...
    @if ($document->purchase_order)
        <tr>
            <td width="120px">ORDEN DE COMPRA/SERVICIO</td>
            <td width="8px">:</td>
...
<table class="full-width">
    <tr>
        <td>
            Somos agentes de retención del IGV (R.S. 139-2015) a partir de 01-07-2015.
        </td>
    </tr>
</table>
</body>
