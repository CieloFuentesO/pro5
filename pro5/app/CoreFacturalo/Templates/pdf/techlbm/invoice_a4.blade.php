...
<table class="full-width mt-10 mb-10">
    ...
    @foreach($document->items as $row)
        <tr>
            ...
            <td class="text-left align-top">{{ $row->m_item->brand != null ? $row->m_item->brand->name : '' }}</td>
            <td class="text-left align-top">
                ...
                @if(isset($row->item->is_set) && $row->item->is_set == 1)
                <br>
    ...
    @endif
        ...
        @if ($document->total_ivap > 0)
            <tr>
                ...
                <td class="text-right font-bold">{{ number_format($document->total_base_ivap, 2) }}</td>
            </tr>
            <tr>
                <td colspan="7" class="text-right font-bold">IVAP: {{ $document->currency_type->symbol }}</td>
                <td class="text-right font-bold">{{ number_format($document->total_ivap, 2) }}</td>
            </tr> 
        @else
            <tr>
