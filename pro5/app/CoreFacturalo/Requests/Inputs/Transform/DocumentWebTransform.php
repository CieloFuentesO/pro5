...
//            'establishment' => EstablishmentTransform::transform($inputs['datos_del_emisor']),
            ...
            'totales' => [
                ...
                'total_ivap' => Functions::valueKeyInArray($inputs, 'total_ivap'),
                'total_base_ivap' => Functions::valueKeyInArray($inputs, 'total_base_ivap'),
        ...
        if(key_exists('items', $inputs)) {
            ...
            foreach ($inputs['items'] as $row) {
                ...
                $items[] = [
                    ...
                    'total_ivap' => Functions::valueKeyInArray($row, 'total_ivap'),
                    'total_base_ivap' => Functions::valueKeyInArray($row, 'total_base_ivap'),
                    'percentage_ivap' => Functions::valueKeyInArray($row, 'percentage_ivap'),
