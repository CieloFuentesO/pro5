...
class DocumentInput
{
    public static function set($inputs)
    {
        ...
        return [
            ...
            'total_ivap' => Functions::valueKeyInArray($inputs, 'total_ivap', 0),
            'total_base_ivap' => Functions::valueKeyInArray($inputs, 'total_base_ivap', 0),
        ...
        if (array_key_exists('items', $inputs)) {
            ...
            foreach ($inputs['items'] as $row) {
                ...
                $arayItem = [
                    ...
                    'total_ivap' => Functions::valueKeyInArray($row, 'total_ivap', 0),
                    'total_base_ivap' => Functions::valueKeyInArray($row, 'total_base_ivap', 0),
                    'percentage_ivap' => Functions::valueKeyInArray($row, 'percentage_ivap', 0),
