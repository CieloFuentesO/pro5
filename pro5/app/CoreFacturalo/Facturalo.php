...
//                    $row['item']['purchase_unit_price'] = $purchase_unit_price;
    ...
    public function createPdf($document = null, $type = null, $format = null, $output = 'pdf') {
        ...
        /* fabro */
        $document_number_pdf = $this->document->series.'-'.str_pad($this->document->number, 8, '0', STR_PAD_LEFT);
        ...
        //config(['tenant.pdf_template'=> $configuration]);
        ...
        if (($format_pdf === 'ticket') OR
            ($format_pdf === 'ticket_58') OR
            ($format_pdf === 'ticket_50') OR
            ($format_pdf === 'ticketguillen') OR
            ($format_pdf === 'ticketgafitas'))
        {
            $base_pdf_template = Establishment::find($this->document->establishment_id)->template_ticket_pdf;
        ...
        */
            ...
            if ($base_pdf_template === 'brand' || $base_pdf_template === 'transcadenas') {
                $pdf_margin_top = 93.7;
                $pdf_margin_bottom = 74;
            }
            if($base_pdf_template === 'tecyme'){
                $pdf_margin_top = 108;
                $pdf_margin_bottom = 74;
            }
            if ($base_pdf_template === 'blank' && in_array($this->document->document_type_id, ['09'])) {
        ...
        if ($base_pdf_template === 'brand' || $base_pdf_template === 'tecyme') {
        ...
        if (($format_pdf != 'ticket') AND ($format_pdf != 'ticket_58') AND ($format_pdf != 'ticket_50') AND ($format_pdf != 'ticketguillen') AND ($format_pdf != 'ticketgafitas')) {
...
//            $pdf->SetHTMLFooter($html_footer);
        ...
        if ($base_pdf_template === 'brand' || $base_pdf_template === 'tecyme' || $base_pdf_template === 'transcadenas') {
        ...
        if($output == 'html') {
            ...
            $pdf->SetTitle($document_number_pdf);
