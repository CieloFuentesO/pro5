...
class DashboardUtility
{
    ...
    private function getPurchaseUnitPrice($record){
        ...
        $presentation_factor = (isset($record["item"]->presentation->quantity_unit)) ? $record["item"]->presentation->quantity_unit : null;
        ...
        if($record->item->unit_type_id != 'ZZ'){
            ...
            if($presentation_factor != null){
                $purchase_unit_price = $purchase_unit_price * $presentation_factor;
            }

        }
        //dd($purchase_unit_price);
