    ...
    Route::domain($hostname->fqdn)->group(function () {
        Route::middleware(['auth', 'locked.tenant'])->group(function() {
            ...
            Route::prefix('item-lots-group')->group(function () {
                ...
                Route::get('', 'ItemLotGroupController@index')->name('tenant.item-lots-group.index');
                Route::get('/records', 'ItemLotGroupController@records');
                Route::get('/record/{record}', 'ItemLotGroupController@record');
                Route::post('', 'ItemLotGroupController@store');
                Route::get('/columns', 'ItemLotGroupController@columns');
                Route::get('/export', 'ItemLotGroupController@export');
