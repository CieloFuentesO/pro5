                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12 ">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-12 pb-2">
                                    <template v-if="search.column=='date_of_due'">
                                        <el-date-picker
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="(row, index) in records" :key="index">
                                            ...
                                            <td>{{ row.orphaned }}</td>
                                            <td class="text-right">
                                                <button type="button" class="btn waves-effect waves-light btn-xs btn-info" @click.prevent="clickCreate(row.id)" v-if="row.is_base">Editar</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
